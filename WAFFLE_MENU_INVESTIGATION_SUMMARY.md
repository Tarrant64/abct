...
The waffle menu navigation is broken on **wallets.html** and **apis.html** (and also **nft-wall.html**) on the Unraid deployment at http://YOUR_SERVER_IP:8081.
...
**Note:** This script requires SSH password authentication to root@YOUR_SERVER_IP
...
1. Open http://YOUR_SERVER_IP:8081/wallets.html
