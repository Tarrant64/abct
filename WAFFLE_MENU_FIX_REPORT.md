...
## Summary
The waffle menu is broken on **wallets.html** and **apis.html** on the Unraid deployment at `http://192.168.50.225:8081`. Additionally, **nft-wall.html** has a separate JavaScript error preventing the waffle menu from working.
...
1. SSH to Unraid: `ssh root@192.168.50.225`
...
1. Navigate to `http://192.168.50.225:8081/wallets.html`
