...
## Summary
The waffle menu is broken on **wallets.html** and **apis.html** on the Unraid deployment at `http://YOUR_SERVER_IP:8081`. Additionally, **nft-wall.html** has a separate JavaScript error preventing the waffle menu from working.
...
1. SSH to Unraid: `ssh root@YOUR_SERVER_IP`
...
1. Navigate to `http://YOUR_SERVER_IP:8081/wallets.html`
