...
async def get_helium_staking(wallet_address: str) -> Optional[Dict]:
    ...
    if hnt_data and (hnt_data['pending'] > 0 or hnt_data['lifetime'] > 0):
        ...
        staked.append({
            ...
            'logo_url': 'https://img.logokit.com/crypto/HNT?token=pk_fr08287a4c625f400f32a9&size=32',
        })
    ...
    if mobile_data and (mobile_data['pending'] > 0 or mobile_data['lifetime'] > 0):
        staked.append({
            ...
            'positions': 0,
            'logo_url': 'https://img.logokit.com/crypto/MOBILE?token=pk_fr08287a4c625f400f32a9&size=32',
        })
