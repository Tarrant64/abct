...
**Application URL:** http://192.168.1.100:8081 (Unraid Deployment)
...
**Error Message:**
```
GET http://192.168.1.100:8081/api/nft-scheduler/status [404 Not Found]
```
...
**Error Message:**
```
GET http://192.168.1.100:8081/exchanges/coinbase [503 Service Unavailable]
...
**API Test Result:**
```bash
$ curl http://192.168.1.100:8081/portfolio/summary
{
  "cardano": {
    "wallet_count": 21,
...
Based on testing, the server at `http://192.168.1.100:8081` shows:
