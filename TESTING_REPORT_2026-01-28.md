...
**Application URL:** http://YOUR_SERVER_IP:8081 (Unraid Deployment)
...
**Error Message:**
```
GET http://YOUR_SERVER_IP:8081/api/nft-scheduler/status [404 Not Found]
```
...
**Error Message:**
```
GET http://YOUR_SERVER_IP:8081/exchanges/coinbase [503 Service Unavailable]
...
**API Test Result:**
```bash
$ curl http://YOUR_SERVER_IP:8081/portfolio/summary
{
  "cardano": {
    "wallet_count": 21,
...
Based on testing, the server at `http://YOUR_SERVER_IP:8081` shows:
