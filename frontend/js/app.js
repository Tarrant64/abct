...
function getLogoKitUrl(symbol, size = 64) {
    const apiKey = 'pk_fr08287a4c625f400f32a9'; // Publishable token (safe for frontend)
        ...
        if (hasAdaDelegation) {
            ...
            html += `
                <div class="defi-gov-card staked">
                    <div class="card-header">
                        <span class="token-logo-wrap"><img src="https://img.logokit.com/crypto/ADA?token=pk_fr08287a4c625f400f32a9&size=32" alt="ADA" class="token-logo-staking" onerror="this.parentElement.innerHTML='<span class=\\'logo-fallback\\'>ADA</span>'"></span>
...
function renderExchangeAssets(assets) {
    ...
    for (const asset of assets) {
        ...
        // Get token logo with fallback
        const tokenLogoUrl = `https://img.logokit.com/crypto/${asset.currency}?token=pk_fr08287a4c625f400f32a9&size=32`;
